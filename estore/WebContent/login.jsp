...
<body
	...
	<form action="${pageContext.request.contextPath }/loginServlet" method=post name="login" id="form">
		<table cellpadding=3 cellspacing=1 align=center class=tableborder1>
			...
			<tr>
				...
				<td valign=middle class=tablebody1><INPUT name=userid type=text id="username">
