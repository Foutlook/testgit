	...
	<table cellspacing=1 cellpadding=3 align=center class=tableBorder2>
		<tr>
			<td height=25 valign=middle><img src="images/Forum_nav.gif"
				...
				color="red">${customer.name }</font>光临！</td>
		</tr>
	</table>
	<br>
		...
		<c:forEach items="${allBooks}" var="book">
			<tr>
				...
				<td class=tablebody1 valign=middle width="">&nbsp;&nbsp;<a
					href="productDetail.jsp?bookname=${book.name }&bookprice=${book.price}&bookid=${book.id}">${book.name}</a></td>
				<td class=tablebody2 valign=middle align=center width="">${book.price}</td>
				<td class=tablebody1 valign=middle align=center width=""><a
					href="${pageContext.request.contextPath }/addOrderlineServlet?bookid=${book.id }"> <img border="0" src="images/car_new.gif"
