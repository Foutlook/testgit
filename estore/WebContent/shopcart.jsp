...
<body
	...
	<table cellpadding=3 cellspacing=1 align=center class=tableborder1>
		...
		<c:forEach items="${lines}" var="entry">
			<tr>
				<form method="post"
					action="${pageContext.request.contextPath}/editOrderlineServlet"
					name="f1">
					<input type="hidden" name="productid" value="${entry.value.book.id }"> <input
						type="hidden" name="number" value="${entry.value.num}">
					<td class=tablebody2 valign=middle align=center width="">${entry.value.book.id }</td>
					<td class=tablebody1 valign=middle width="">&nbsp;&nbsp;<a
						href="productDetail.jsp?productid=2">${entry.value.book.name}</a></td>
					...
					<td class=tablebody2 valign=middle align=left width="">&nbsp;&nbsp;${entry.value.num*entry.value.book.price}</td>
					<td class=tablebody1 valign=middle align=center width=""><input
						type="button" value="取消"
						onclick="javascript:window.location='${pageContext.request.contextPath}/delOrderlineServlet?bookid=${entry.value.book.id }';">
		...
		<tr>
			...
			<td class=tablebody1 valign=middle align=left width="">&nbsp;&nbsp;<font
				color="#ff0000"><b>¥${shoppingCar.cost }</b></font></td>
		...
		<tr>
			<td class=tablebody2 valign=middle align=center colspan="6"><input
				...
				onclick="javascript:window.location='${pageContext.request.contextPath}/clearCartServlet';"></td>
		</tr>
	</table>
	<br>
	<!--文件尾开始-->
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0"
		...
		<tr>
			<td bgcolor="#f1f1f6" height="53" valign="center">
				<p align="center">
					Copyright &copy;2004 - 2013 <a href="http://fxkoutlook.cn"><b><font
