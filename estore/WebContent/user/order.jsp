...
<body
					...
					<tr>
						...
						<td width="10%"><a href="../index.jsp"
							...
							onMouseOver="MM_swapImage('Image1','','../images/index_on.gif',1)">
								<img name="Image1" border="0" src="../images/index.gif"
								width="90" height="36">
						</a></td>
	...
	<table cellpadding=3 cellspacing=1 align=center class=tableborder1>
		...
		<c:forEach items="${orderByCusId }" var="order" varStatus="o">
			<tr>
				<td class=tablebody2 valign=middle align=center width="">${o.index+1 }</td>
				<td class=tablebody1 valign=middle width="">&nbsp;&nbsp;<a
					href="../user/orderinfo.jsp?orderid=${order.id }">${order.id }</a></td>
				...
				<td class=tablebody2 valign=middle align=left width="">&nbsp;&nbsp;邮局汇款
				</td>
				<td class=tablebody1 valign=middle align=center width=""><input
					type="button" value="删除"
					onclick="javascript:window.location='${pageContext.request.contextPath}/delOrderServlet?orderid=${order.id}';">&nbsp;<input
					type="button" value="明细"
					onclick="javascript:window.location='${pageContext.request.contextPath}/orderinfoServlet?orderid=${order.id}';">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0"
		...
		<tr>
			<td bgcolor="#f1f1f6" height="53" valign="center">
				<p align="center">
					Copyright &copy;2014 - 2018 <a href="http://fxkoutlook.cn"><b><font
