...
<body
	...
	<form method="post" name="reg" action="${pageContext.request.contextPath }/updateServlet">
		<table cellpadding="3" cellspacing="1" align="center"
			...
			<tr>
				...
				<td width="60%" class="tablebody1"><input type="hidden"
					name="userid" value="${customer.name}"> <input type="text"
					maxLength="8" size="32" disabled  value="${customer.name }"
			...
			<tr>
				...
				<td width="60%" class="tablebody1"><input type="password"
					maxLength="8" size="32" name="password" value="${customer.password }"
					style="font-family: Tahoma, Verdana, 宋体; font-size: 12px; line-height: 15px; color: #000000">
					<font color="#FF0000">*</font></td>
			</tr>
			<tr>
				...
				<td class="tablebody1"><input type="password" maxLength="8"
					size="32" name="password2" value="${customer.password }"
					style="font-family: Tahoma, Verdana, 宋体; font-size: 12px; line-height: 15px; color: #000000">
					<font color="#FF0000">*</font></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="tablebody1"><input type="text" size="32"
					maxlength="16" name="cellphone" value="${customer.telephone }"
					style="font-family: Tahoma, Verdana, 宋体; font-size: 12px; line-height: 15px; color: #000000">
				</td>
			</tr>
			<tr>
				...
				<td class="tablebody1"><input maxLength="50" size="32"
					maxlength="32" name="email" value="${customer.email }"
