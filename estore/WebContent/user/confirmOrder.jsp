...
<body
	...
	<form name="order" method="post" action="${pageContext.request.contextPath }/confirmServlet" />
	...
	<c:forEach items="${lines }" var="entry">
		<tr>
			...
			<td class=tablebody1 valign=middle width="">&nbsp;&nbsp;<a
				href="../productDetail.jsp?productid=2" target="_blank">${entry.value.book.name }</a></td>
			<td class=tablebody2 valign=middle align=center width="">${entry.value.book.price}</td>
			<td class=tablebody1 valign=middle align=center width="">${entry.value.num }</td>
