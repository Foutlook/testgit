...
<body
	...
	<form method="post" name="reg" action="${pageContext.request.contextPath }/registerServlet">
		<table cellpadding="3" cellspacing="1" align="center"
			...
			<tr>
				<td width="40%" class="tablebody1"><b>用户名</b>：<br>
					注册用户名长度限制为0－16字节</td>
				<td width="60%" class="tablebody1"><input maxLength="8" size="32"
					name="userid"
			...
			<tr>
				...
				<td class="tablebody1"><select name="country"
					...
					style="font-family: Tahoma, Verdana, 宋体; font-size: 12px; line-height: 15px; color: #000000">市/县</td>
			</tr>
			<tr>
